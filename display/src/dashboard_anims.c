...
const info_screen INFO_SCREENS[INFO_MODE_COUNT] = {
    [0] = {
        ...
        .x = { 0, 0 }, .y = { 176, 273 }, .w = { 510, 454 }, .h = { 97, 125 },
    },
    [1] = {
    ...
    [3] = {
        ...
        .x = { 0, 0 }, .y = { 158, 0 }, .w = { 434, 0 }, .h = { 268, 0 },
    },
};

static int info_current_mode = 0;

int dashboard_anims_info_mode(void) { return info_current_mode; }
void dashboard_anims_set_info_mode(int mode) { info_current_mode = mode; }
