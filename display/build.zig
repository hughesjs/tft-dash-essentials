...
pub fn build(b: *std.Build) void {
    ...
    dashboard.root_module.addCSourceFiles(.{
        .files = &.{ "src/main.c", "src/draw.c", "src/draw_dashboard.c", "src/draw_menu.c", "src/parser.c", "src/assets.c", "src/sensor_feed.c", "src/menu.c", "src/tpms_feed.c", "src/animation.c", "src/dashboard_anims.c", "src/warnings.c" },
        .flags = &.{"-std=c23"},
    });
    ...
    if (!is_cross) {
        ...
        // --- Animation tests ---
        const test_animation = b.addExecutable(.{
            .name = "test_animation",
            .root_module = b.createModule(.{
                .target = target,
                .optimize = optimize,
        ...
        test_animation.root_module.addCSourceFiles(.{
            .files = &.{
        ...
        test_animation.root_module.addIncludePath(b.path("src"));
        test_animation.root_module.linkSystemLibrary("m", .{});
